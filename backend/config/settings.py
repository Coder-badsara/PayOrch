...
HEALTH_DEGRADED_THRESHOLD = env('HEALTH_DEGRADED_THRESHOLD', default=0.7, cast=float)
HEALTH_UNHEALTHY_THRESHOLD = env('HEALTH_UNHEALTHY_THRESHOLD', default=0.4, cast=float)
